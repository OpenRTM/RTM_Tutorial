...
/*!
 * @class drawGraphTestComp
 * @brief Standalone component Class
 *
 */
public class drawGraphTestComp implements ModuleInitProc {

    public void myModuleInit(Manager mgr) {
      Properties prop = new Properties(drawgraphtest_conf);
      mgr.registerFactory(prop, new drawGraphTest(), new drawGraphTest());

      // Create a component
      RTObject_impl comp = mgr.createComponent("drawGraphTest");
      if( comp==null ) {
