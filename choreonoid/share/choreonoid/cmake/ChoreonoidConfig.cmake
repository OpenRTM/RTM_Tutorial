...
set(CHOREONOID_ROOT_DIR C:/workspace/choreonoid/build/install)

if(NOT CMAKE_VERSION VERSION_LESS 3.7.0)
  if(CMAKE_INSTALL_PREFIX_INITIALIZED_TO_DEFAULT)
    set(CMAKE_INSTALL_PREFIX "C:/workspace/choreonoid/build/install" CACHE PATH "Install path prefix, prepended onto install directories." FORCE)
  endif()
endif()
...
set(CHOREONOID_BIN_DIR "C:/workspace/choreonoid/build/install/bin")
set(CHOREONOID_LIB_SUBDIR lib)
set(CHOREONOID_LIB_DIR "C:/workspace/choreonoid/build/install/lib")
set(CHOREONOID_PLUGIN_SUBDIR lib/choreonoid-1.8)
set(CHOREONOID_PLUGIN_DIR "C:/workspace/choreonoid/build/install/lib/choreonoid-1.8")
set(CHOREONOID_HEADER_SUBDIR include)
set(CHOREONOID_SHARE_SUBDIR share)
set(CHOREONOID_SHARE_DIR "C:/workspace/choreonoid/build/install/C:/workspace/choreonoid/build/install/share")
...
set(CHOREONOID_COMPILE_DEFINITIONS "$<$<CONFIG:Debug>:CNOID_DEBUG>;_ENABLE_EXTENDED_ALIGNED_STORAGE;_WIN64;NOMINMAX;_USE_MATH_DEFINES;_CRT_SECURE_NO_WARNINGS;HAVE_SNPRINTF;BOOST_ALL_DYN_LINK;__WIN32__;__x86__")
set(CHOREONOID_DEFAULT_FVISIBILITY_HIDDEN OFF)
set(CHOREONOID_INCLUDE_DIRS "C:/workspace/choreonoid/build/install/include;C:/Python37/include;C:/local/boost_1_77_0;C:/workspace/openrtm41/build_omni43/install/2.0.0/omniORB/4.3.0_vc142/include")
set(CHOREONOID_LIBRARY_DIRS "C:/workspace/choreonoid/build/install/lib;C:/workspace/choreonoid/build/install/lib/choreonoid-1.8;C:/local/boost_1_77_0/lib;C:/workspace/openrtm41/build_omni43/install/2.0.0/omniORB/4.3.0_vc142/lib/x86_win32")

if(true)
  find_package(Boost 1.77.0 EXACT COMPONENTS system)
  list(APPEND CHOREONOID_UTIL_LIBRARIES optimized;C:/local/boost_1_77_0/lib/boost_system-vc142-mt-x64-1_77.lib;debug;C:/local/boost_1_77_0/lib/boost_system-vc142-mt-gd-x64-1_77.lib)
endif()
...
target_link_libraries(Choreonoid::CnoidUtil INTERFACE fmt;libintl-8;${Boost_LIBRARIES})
...
if(MSVC)
  set(CHOREONOID_USE_SUBSYSTEM_CONSOLE OFF)
endif()

set(CHOREONOID_ENABLE_GETTEXT ON)
if(CHOREONOID_ENABLE_GETTEXT)
  set(CHOREONOID_GETTEXT_MSGFMT_EXECUTABLE "C:/workspace/choreonoid/thirdparty/gettext-0.21/bin/msgfmt.exe")
endif()
...
if(CHOREONOID_ENABLE_PYTHON)
  ...
  target_link_libraries(Choreonoid::CnoidPyUtil INTERFACE "C:/Python37/libs/python37.lib")
...
set(CHOREONOID_ENABLE_CORBA true)
if(CHOREONOID_ENABLE_CORBA)
  set(CHOREONOID_OMNIORB_DIR "C:/workspace/openrtm41/build_omni43/install/2.0.0/omniORB/4.3.0_vc142")
  set(CHOREONOID_OMNIORB_BINARY_DIR "C:/workspace/openrtm41/build_omni43/install/2.0.0/omniORB/4.3.0_vc142/bin/x86_win32")
  set(CHOREONOID_CORBA_LIBRARIES CnoidCorba "optimized;omniORB430_rt;debug;omniORB430_rtd;optimized;omnithread43_rt;debug;omnithread43_rtd;optimized;omniDynamic430_rt;debug;omniDynamic430_rtd")
