# Python stubs generated by omniidl from C:\workspace\openrtmpy1\OpenRTM_aist\RTM_IDL\OpenRTM.idl
...
#
__name__ = "OpenRTM"
_0_OpenRTM = omniORB.openModule("OpenRTM", r"C:\workspace\openrtmpy1\OpenRTM_aist\RTM_IDL\OpenRTM.idl")
_0_OpenRTM__POA = omniORB.openModule("OpenRTM__POA", r"C:\workspace\openrtmpy1\OpenRTM_aist\RTM_IDL\OpenRTM.idl")
...
_0_OpenRTM._d_FiniteStateMachineComponent = (omniORB.tcInternal.tv_objref, "IDL:openrtm.aist.go.jp/OpenRTM/FiniteStateMachineComponent:1.0", "FiniteStateMachineComponent")
omniORB.typeMapping["IDL:openrtm.aist.go.jp/OpenRTM/FiniteStateMachineComponent:1.0"] = _0_OpenRTM._d_FiniteStateMachineComponent
_0_OpenRTM.FiniteStateMachineComponent = omniORB.newEmptyClass()
class FiniteStateMachineComponent (_0_RTC.RTObject, _0_RTC.FsmParticipant):
    _NP_RepositoryId = _0_OpenRTM._d_FiniteStateMachineComponent[1]
...
_0_OpenRTM.FiniteStateMachineComponent = FiniteStateMachineComponent
_0_OpenRTM._tc_FiniteStateMachineComponent = omniORB.tcInternal.createTypeCode(_0_OpenRTM._d_FiniteStateMachineComponent)
omniORB.registerType(FiniteStateMachineComponent._NP_RepositoryId, _0_OpenRTM._d_FiniteStateMachineComponent, _0_OpenRTM._tc_FiniteStateMachineComponent)
...
class _objref_FiniteStateMachineComponent (_0_RTC._objref_RTObject, _0_RTC._objref_FsmParticipant):
    ...
    def __init__(self, obj):
        _0_RTC._objref_RTObject.__init__(self, obj)
        _0_RTC._objref_FsmParticipant.__init__(self, obj)

omniORB.registerObjref(FiniteStateMachineComponent._NP_RepositoryId, _objref_FiniteStateMachineComponent)
_0_OpenRTM._objref_FiniteStateMachineComponent = _objref_FiniteStateMachineComponent
...
class FiniteStateMachineComponent (_0_RTC__POA.RTObject, _0_RTC__POA.FsmParticipant):
    _NP_RepositoryId = _0_OpenRTM.FiniteStateMachineComponent._NP_RepositoryId
...
_0_OpenRTM__POA.FiniteStateMachineComponent = FiniteStateMachineComponent
omniORB.registerSkeleton(FiniteStateMachineComponent._NP_RepositoryId, FiniteStateMachineComponent)
